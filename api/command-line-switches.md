...
### \--force\_high\_performance\_gpu

Force using discrete GPU when there are multiple GPUs available.

### \--force\_low\_power\_gpu
...
When enabled, DevTools can retrieve remote source maps for main and utility process scripts via the Node.js inspector.
...
Enables the [transformation](https://nodejs.org/api/typescript.html#type-stripping) of TypeScript-only syntax into JavaScript code.
