...
If you need to install Electron through a custom mirror or proxy, see the [Advanced Installation](tutorial/installation.md) documentation for more details.

## How are Electron binaries downloaded?

When you run `npm install electron`, the main `bin` script is downloaded. Once this is run (for example, via `npx electron`), the Electron binary for the corresponding version is downloaded into your project's node\_modules folder dynamically via the `install-electron` script.
...
See the [Electron Releases](tutorial/electron-timelines.md) documentation for more details or [releases.electronjs.org](https://releases.electronjs.org/) to see our Release Status dashboard.
...
![Subpixel rendering example](https://www.electronjs.org/assets/images/subpixel-rendering-screenshot-4945bc4a4d08579f9ec84f705bfea1b1.gif)
