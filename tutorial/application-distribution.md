...
There are a couple tools out there that exist to package and distribute your Electron app. We recommend using [Electron Forge](forge-overview.md). You can check out its [documentation](https://www.electronforge.io/) directly, or refer to the [Packaging and Distribution](tutorial-packaging.md) part of the Electron tutorial.
