...
To create a click-through window, i.e. making the window ignore all mouse events, you can call the [win.setIgnoreMouseEvents(ignore)](../api/browser-window.md#winsetignoremouseeventsignore-options) API:
