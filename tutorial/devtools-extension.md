...
4. Pass the location of the extension to the [`ses.loadExtension`](../api/extensions-api.md#extensionsloadextensionpath-options) API. For React Developer Tools `v4.9.0`, it looks something like:
	```js
...
You can pass the extension's ID to the [`ses.removeExtension`](../api/extensions-api.md#extensionsremoveextensionextensionid) API to remove it from your Session. Loaded extensions are not persisted between app launches.
