...
static void notify_callback(const TodoCallback &callback, const std::string &json)
{
  ...
  {
    g_main_context_invoke(g_gtk_main_context,  -> gboolean
                          {
...
- Calls our C++ hello\_world function
- Returns the result as a JavaScript string

`HelloGui()`:

- Simply calls our C++ hello\_gui function without arguments
...
### Putting cpp\_addon.cc together
