...
To add a file to recent documents, use the [app.addRecentDocument](../api/app.md#appaddrecentdocumentpath-macos-windows) API.
...
![Recent document](https://www.electronjs.org/assets/images/recent-documents-d86e2866546b01a075b73d23b14fb56f.png)

#### Clearing the list of recent documents

To clear the list of recent documents, use the [app.clearRecentDocuments](../api/app.md#appclearrecentdocuments-macos-windows) API. In this guide, the list of documents is cleared once all windows have been closed.

#### Accessing the list of recent documents

To access the list of recent documents, use the [app.getRecentDocuments](../api/app.md#appgetrecentdocuments-macos-windows) API.
