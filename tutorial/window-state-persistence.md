...
- [windowStatePersistence in BaseWindowConstructorOptions](../api/structures/base-window-options.md)
- [WindowStatePersistence object structure](../api/structures/window-state-persistence.md)
- [`BaseWindow.clearPersistedState()`](../api/base-window.md#basewindowclearpersistedstatename)
- [`persisted-state-restored` event](../api/base-window.md#event-persisted-state-restored)
