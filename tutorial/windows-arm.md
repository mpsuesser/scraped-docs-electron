...
3. [If you have Electron installed as a development dependency](tutorial-first-app.md#initializing-your-npm-project), npm will download and unpack the arm64 version. You can then package and distribute your app as normal.
...
1. Duplicate the *x64\_x86 Cross Tools Command Prompt for VS 2017* shortcut (e.g. by locating it in the start menu, right clicking, selecting *Open File Location*, copying and pasting) to somewhere convenient.
...
1. Download the arm64 `node.lib` from [https://electronjs.org/headers/v6.0.9/win-arm64/node.lib](https://electronjs.org/headers/v6.0.9/win-arm64/node.lib)
...
4. Click *Refresh* and select the [appropriate Electron process to attach](../development/debugging-on-windows.md).
