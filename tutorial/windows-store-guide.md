...
Before running the CLI for the first time, you will have to setup the "Windows Desktop App Converter". This will take a few minutes, but don't worry - you only have to do this once. Download the Desktop App Converter from [here](https://learn.microsoft.com/en-us/windows/msix/packaging-tool/tool-overview). You will receive two files: `DesktopAppConverter.zip` and `BaseImage-14316.wim`.
