...
![Taskbar JumpList](https://www.electronjs.org/assets/images/windows-taskbar-jumplist-150789129102203795fc34e12d8b0a3d.png)
...
Starting with a working application from the [tutorial starter code](tutorial-first-app.md#final-starter-code), update the `main.js` file with the following lines:
...
![Thumbnail toolbar](https://www.electronjs.org/assets/images/windows-taskbar-thumbnail-toolbar-22cd663bb43cf384c21b3a35f366bc03.png)
...
![Overlay on taskbar button](https://www.electronjs.org/assets/images/windows-taskbar-icon-overlay-09789472d59274bd9e408da750519e94.png)
